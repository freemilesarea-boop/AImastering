...
export interface InitOutput {
    ...
    readonly louimasteringchain_ditherEngaged: (a: number) => number;
    readonly louimasteringchain_ditherLsbDbfs: (a: number) => number;
    ...
    readonly louimasteringchain_monitorDryLufs: (a: number) => number;
    readonly louimasteringchain_monitorLoudnessDeltaDb: (a: number) => number;
    readonly louimasteringchain_monitorMatchGainDb: (a: number) => number;
    readonly louimasteringchain_monitorWetLufs: (a: number) => number;
    readonly louimasteringchain_monitoringActive: (a: number) => number;
