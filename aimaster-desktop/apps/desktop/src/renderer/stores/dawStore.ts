...
export type DawWindow = 'edit' | 'mix' | 'midi' | 'chain' | 'session' | 'spectral' | 'reference' | 'warp' | 'restore';
...
export const useDawStore = create<DawState>((set, get) => ({
  ...
  toggleWindow: () => set((s) => {
    const order: DawWindow[] = ['edit', 'mix', 'midi', 'chain', 'session', 'warp', 'spectral', 'restore', 'reference'];
